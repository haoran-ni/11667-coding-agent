...
def dequantize_model(model, tokenizer=None, to=None, dtype=torch.bfloat16, device="cpu"):
    """
...
def main():
    model_path = './models/1/finetuned_llama_3B_low_lr/merged_model'
    adapter_path = './models/evaluate/placeholder_2/checkpoint-111'
